...
try:
    ...
    print('__________________________________________________________________________Artist')
    print()
    print(Artist(File))
    print()

    print('___________________________________________________________________________Album')
    print()
    print(Album(File))
    print()

    print('___________________________________________________________________________Title')
    print()
    print(Title(File))
    print()
